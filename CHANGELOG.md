...
- Per-category contribution totals (`profile.contributions`: reviews, ratings,
  photos, videos, captions, answers, edits, places/roads added, Q&A and more)
  read from the profile's contributions dialog
